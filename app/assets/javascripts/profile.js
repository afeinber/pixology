...
var ProfileApp = {
  ...
  addInterest: function(){
    description = $("#interest-form").val();
    $("#interest-form").val('');
    requestObj = {category: {description: description}};
    $.ajax({
      type: "POST",
    ...
    .done(function() {
      this.appendInterest(description);
    }.bind(this));
    event.preventDefault();
  },
  appendInterest: function(desc){
  ...
  initializer: function(event){
    ...
    $('#add-interest').on('click',this.addInterest.bind(this));
